...
namespace MFlight.Demo {
	...
	public class Plane : MonoBehaviour {
		[Header("Components")] public ControllerManager controller;
		...
		private void Update() {
			...
			RunAutopilot(controller.GetController().MouseAimPos, out autoYaw, out autoPitch, out autoRoll);
...
//			roll = Mathf.InverseLerp(0, 1, transform.right.y);
		}
